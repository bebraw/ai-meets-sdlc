...
Architecture decisions for the SDLCAI site are recorded here. Records are
numbered in the order they are accepted and are not rewritten after an
implementation change; a later record supersedes an earlier one when the
decision changes.
